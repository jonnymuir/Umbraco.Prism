...
public class WorkflowActionRegistryTests
{
    ...
    public void ServiceRegistration_ExposesRuntimeRegistryAsCatalogSource()
    {
        ...
        services.AddBusinessAppWorkflowActions();
    ...
    private static WorkflowActionRegistry CreateRegistry() =>
        new(
    ...
    private static WorkflowActionExecutionContext CreateContext() =>
        new()
        {
            Definition = new WorkflowDefinitionFile
            {
                ...
                States =
                [
                    new StepDefinition { StateKey = "start", DisplayName = "Start", Components = [] },
                    new StepDefinition { StateKey = "review", DisplayName = "Review", Components = [] }
                ],
                Transitions =
                [
                    new WorkflowTransitionFile { FromState = "start", ToState = "review", Action = "submit" }
                ]
            },
            ...
            SourceState = new StepDefinition { StateKey = "start", DisplayName = "Start", Components = [] },
            TargetState = new StepDefinition { StateKey = "review", DisplayName = "Review", Components = [] },
            Transition = new WorkflowTransitionFile { FromState = "start", ToState = "review", Action = "submit" },
...
public class BusinessAppWorkflowEngineActionExecutionTests : IDisposable
{
    ...
    private readonly Mock<ILogger<BusinessAppWorkflowEngine>> _logger = new();
    private readonly Mock<IWorkflowContentSanitizer> _sanitizer = new();
    ...
    private void SeedWorkflow()
    {
        var workflow = new WorkflowDefinitionFile
        {
            ...
            [
                new WorkflowTransitionFile
                {
                    ...
                    ToState = "submitted",
                    Action = "submit",
                    Metadata = new WorkflowTransitionMetadata
                    {
                        Actions =
                        [
                            new WorkflowActionDefinition
        ...
        File.WriteAllText(
            Path.Combine(_testSeedDir, "workflow-seeds", "workflow-actions.json"),
    ...
    private sealed class RecordingWorkflowActionHandler : IWorkflowActionHandler
    {
            ...
            CancellationToken cancellationToken)
        {
            Invocations.Add(new RecordedInvocation(
                ...
                context.SourceState?.StateKey,
                context.TargetState.StateKey,
