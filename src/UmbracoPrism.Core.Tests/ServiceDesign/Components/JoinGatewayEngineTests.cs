...
/// </summary>
public class JoinGatewayEngineTests
{
    ...
    private static ServiceBlueprint BuildTwoQueueDefinition() => new()
    {
        ...
        Queues =
        [
            new QueueDefinition { Key = "applicant", DisplayName = "Applicant", Actor = "applicant" },
