...
public class PlanningServiceBlueprintFixtureTests
{
    ...
    private static string FixturePath => Path.Combine(
        ...
        "ServiceDesign", "Authoring", "Fixtures", "planning.json");
    ...
    {
        var original = JsonSerializer.Deserialize<AuthoredServiceBlueprint>(File.ReadAllText(FixturePath), RoundTripOptions)!;
