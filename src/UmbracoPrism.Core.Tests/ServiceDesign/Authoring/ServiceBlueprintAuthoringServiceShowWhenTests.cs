...
/// <summary>
/// Covers the validate-time showWhen pass added to <see cref="ServiceBlueprintAuthoringService.Validate"/>
...
/// </summary>
public class ServiceBlueprintAuthoringServiceShowWhenTests
{
    private static readonly ServiceBlueprintAuthoringService Service = new(new NotSupportedServiceBlueprintSourceStore());
    ...
    private sealed class NotSupportedServiceBlueprintSourceStore : IServiceBlueprintSourceStore
    {
