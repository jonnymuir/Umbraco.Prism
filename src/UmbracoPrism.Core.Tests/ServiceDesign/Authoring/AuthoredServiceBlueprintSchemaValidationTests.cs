...
public class AuthoredServiceBlueprintSchemaValidationTests
{
    ...
    public void SchemaDocument_DefinesStageQueueGatewayAndParameterContracts()
    {
        var path = Path.GetFullPath(Path.Combine(
            ...
            "..", "..", "..", "..",
            "UmbracoPrism.ServiceBlueprintEditor", "Authoring", "Schemas", "authored-service-blueprint.schema.json"));
    ...
    private static AuthoredServiceBlueprint BuildValidWorkflow() => new()
    {
