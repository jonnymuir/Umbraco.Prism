...
/// <summary>
/// Verifies that <see cref="BusinessAppProcessManagerClient"/> routes server-to-server
...
public class BusinessAppProcessManagerClientTests : IDisposable
{
    private readonly string? _savedBackchannelUrl;

    public BusinessAppProcessManagerClientTests()
    {
    ...
    private static BusinessAppProcessManagerClient BuildClient(
    ...
    private static BusinessAppProcessManagerClient BuildClientWithContextMock(
        Dictionary<string, string?> config,
        ...
        string responseBody = """{"instanceId":"inst-1","responseState":"render","stateVersion":1,"correlationId":"c1","serverTimeUtc":"2026-01-01T00:00:00Z","render":{"stepType":"form","stateDisplayName":"Step 1","components":[],"availableActions":[]}}""")
    {
        ...
        return new BusinessAppProcessManagerClient(
            clientFactory.Object,
            configuration,
            prismContext.Object,
            NullLogger<BusinessAppProcessManagerClient>.Instance);
    }
