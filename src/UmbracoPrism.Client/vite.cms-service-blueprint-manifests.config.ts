...
// A dedicated build step for prism-cms-service-blueprint-manifests.js only. This entry's sole content
...
export default defineConfig({
  build: {
    ...
    rollupOptions: {
      input: {
        'prism-cms-service-blueprint-manifests': 'src/backoffice/cms-service-blueprint/manifests.ts',
      },
      output: {
        format: 'es',
