 ...
 */
export class UmbCreateCmsWorkflowOptionAction extends UmbEntityCreateOptionActionBase {
  override async execute(): Promise<void> {
    ...
    const modalHandler = modalManager.open(this, 'Prism.CreateCmsWorkflowModal', {
      type: 'sidebar',
      size: 'small',
    } as never);
...
export { UmbCreateCmsWorkflowOptionAction as api };
export default UmbCreateCmsWorkflowOptionAction;
