// Aggregates every extension manifest for the CMS Workflow backoffice screen. Registered via a
...
// This file is built by its own dedicated vite.cms-workflow-manifests.config.ts, with
