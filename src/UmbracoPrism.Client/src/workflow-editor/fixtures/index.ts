 ...
 * UmbracoPrism.MockBusinessApp/workflow-seeds/money-modeller.json, mirrored
 ...
 * back-office review queue — the most structurally complex real workflow
 * this repo ships, and the one that originally surfaced the graph canvas's
 * chip-collision and edge-routing issues.
 */
export const MONEY_MODELLER_WORKFLOW: AuthoredWorkflow = hydrateWorkflowDefinition({
