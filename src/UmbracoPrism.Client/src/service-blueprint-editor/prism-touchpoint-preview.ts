...
import type { AuthoredTouchpoint } from './types.js';
import type {
  ProjectedComponent,
...
import { humaniseAssignmentLabel } from './touchpoint-assignment.js';
...
export class PrismStagePreviewElement extends LitElement {
  ...
  render() {
    ...
    return html`
      <section class="preview-shell" aria-labelledby="serviceBlueprint-stage-preview-title" data-prism-touchpoint-preview>
...
declare global {
  interface HTMLElementTagNameMap {
    'prism-touchpoint-preview': PrismStagePreviewElement;
  }
}
