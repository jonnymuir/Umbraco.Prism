 ...
 */
@customElement('prism-touchpoint-action-editor')
export class PrismServiceBlueprintActionEditorElement extends LitElement {
  ...
  render() {
    return html`
      <div class="serviceBlueprint-action-editor">
...
declare global {
  interface HTMLElementTagNameMap {
    'prism-touchpoint-action-editor': PrismServiceBlueprintActionEditorElement;
  }
}
