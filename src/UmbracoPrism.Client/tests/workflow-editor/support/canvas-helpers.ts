...
/**
 * Shared helpers for the workflow-editor visual regression suite.
 *
 * Documented in `docs/testing/workflow-editor-visual-tests.md`. Every
 * spec in `workflow-canvas-*.spec.ts` and `workflow-editor-ergonomics.spec.ts`
...
export const CANONICAL_SCENARIOS: readonly CanonicalScenario[] = [
  {
    ...
    storyId: 'workflow-editor-workflow-graph--workspace-canvas',
    hasGateways: false,
    oversize: false,
  },
  {
    id: 'MULTI_LANE_FAN_OUT',
    storyId: 'workflow-editor-workflow-graph--gateway-representation',
    hasGateways: true,
    oversize: false,
  },
  {
    id: 'SAME_LANE_FAN_OUT',
    storyId: 'workflow-editor-workflow-graph--same-lane-fan-out',
    hasGateways: true,
    oversize: false,
  },
  {
    id: 'LARGE_WORKFLOW',
    storyId: 'workflow-editor-workflow-graph--large-workflow',
    hasGateways: false,
    oversize: true,
  },
] as const;
...
export function graphLocator(page: Page): Locator {
  return page.locator('prism-workflow-graph');
}
