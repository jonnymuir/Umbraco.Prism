...
/**
 * Concern 4 from `docs/testing/workflow-editor-visual-tests.md`: every
...
test.describe('Workflow canvas — arrow endpoints land on nodes', () => {
...
test.describe('Workflow canvas — canonical screenshot baselines', () => {
  // Only snapshot scenarios that fit the pinned viewport. LARGE_WORKFLOW is
