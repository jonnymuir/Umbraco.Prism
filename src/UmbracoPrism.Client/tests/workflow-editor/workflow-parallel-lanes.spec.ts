...
// workflow editor. These tests target the gateway-representation story which contains
...
test.describe('Workflow editor parallel lanes', () => {
  ...
  test.skip('completing lanes in reverse order produces the same workflow outcome', async ({ page }) => {
