...
/**
 * Concern 5 from `docs/testing/workflow-editor-visual-tests.md`:
 * the named author flows that make adding and maintaining workflows easy.
 *
...
test.describe('Workflow editor — add/maintain ergonomics', () => {
