...
{
    public string GetWidget(ActionParameterDefinition definition)
    {
    ...
    public IReadOnlyDictionary<string, string> BuildWidgetMap(ActionParameterSchema schema)
    {
    ...
    private void AddWidgets(string path, ActionParameterDefinition definition, IDictionary<string, string> map)
    {
