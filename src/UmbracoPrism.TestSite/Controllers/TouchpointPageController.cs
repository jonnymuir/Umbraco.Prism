...
/// <summary>
/// Umbraco route-hijacking controller for the <c>touchpointPage</c> document type.
...
public class TouchpointPageController(
    ...
    : PrismServiceRequestPageController<TouchpointViewModel>(
        logger,
        compositeViewEngine,
...
{
    /// <summary>
    /// Pre-populates touchpoint fields from authenticated user claims.
