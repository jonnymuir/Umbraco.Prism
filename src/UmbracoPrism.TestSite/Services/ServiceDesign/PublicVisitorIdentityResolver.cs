...
/// <summary>
/// Resolves "who this public service request is from" — the authenticated Prism Member's
/// stable identity when logged in, otherwise an anonymous session identity held in a dedicated
...
/// </summary>
/// <remarks>
/// Extracted so every public-service-request-facing endpoint that needs to resolve "whose
/// instance is this" — <see cref="InProcessPublicVisitorProcessManagerClient"/>'s GET/POST/advance
/// flow, and a file download endpoint that never goes through that client — shares one identity
/// resolution implementation rather than each re-deriving the cookie logic independently.
/// </remarks>
public sealed class PublicVisitorIdentityResolver(
    ...
    IHttpContextAccessor httpContextAccessor)
{
    ...
    /// </summary>
    public const string AnonymousVisitorCookieName = "PrismPublicServiceRequestVisitor";
