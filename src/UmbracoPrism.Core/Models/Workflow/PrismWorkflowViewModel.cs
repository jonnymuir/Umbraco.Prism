...
/// It is populated by <see cref="PrismWorkflowPageController{TViewModel}"/> during GET requests (rendering)
...
/// </list>
/// </remarks>
public class PrismWorkflowViewModel : PublishedContentWrapped
{
    public PrismWorkflowViewModel(IPublishedContent content, IPublishedValueFallback publishedValueFallback)
