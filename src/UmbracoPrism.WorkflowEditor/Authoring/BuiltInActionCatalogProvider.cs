...
/// <summary>
/// Built-in workflow action catalog for Workflow Editor V1.
    ...
    private static IReadOnlyList<ActionCatalogEntry> CreateEntries(IParameterWidgetMapper widgetMapper)
    {
        ...
        [
            CreateEntry(
                ...
                appliesTo: [ActionCatalogScopes.StageOnEntry],
            ...
            CreateEntry(
                ...
                appliesTo: [ActionCatalogScopes.StageOnExit],
                paramsSchema: formReferenceSchema,
                defaultParams: new JsonObject
                {
                    ["formDefinitionId"] = string.Empty
            ...
            CreateEntry(
                ...
                appliesTo: [ActionCatalogScopes.StageOnEntry, ActionCatalogScopes.Transition],
                paramsSchema: new AuthoredParameterSchema
                {
                    Key = "case.assign",
                    Title = "Case assignment",
                    Description = "Parameters for assigning a case as the workflow advances.",
            ...
            CreateEntry(
                ...
                paramsSchema: new AuthoredParameterSchema
                {
                    ...
                    Description = "Parameters for queueing work after a stage or transition.",
            ...
            CreateEntry(
                ...
                appliesTo: [ActionCatalogScopes.StageOnExit, ActionCatalogScopes.Transition],
                paramsSchema: new AuthoredParameterSchema
                {
                    Key = "case.add-note",
                    Title = "Case note",
                    Description = "Parameters for recording a workflow note.",
            ...
            CreateEntry(
                ...
                paramsSchema: new AuthoredParameterSchema
                {
                    ...
                    Description = "Parameters for sending a workflow email.",
            ...
            CreateEntry(
                ...
                paramsSchema: new AuthoredParameterSchema
                {
                    ...
                    Description = "Parameters for sending a workflow SMS.",
