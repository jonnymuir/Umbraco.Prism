...
> **New to Umbraco.Prism?** After the stack starts, see the [Interactive Walkthrough](docs/walkthroughs/planning-notification.md) for a guided tour of the demo workflow with behind-the-scenes explanations.
